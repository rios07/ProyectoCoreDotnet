...
namespace ControladoresCore.ViewModels
{
    public class SoportesVM : BaseVM
    {
        ...
        public int UsuarioQueCerroId { get; set; } = 1;

        [Display(Name = "Usuario que solicita")]
        public int UsuarioQueSolicitaId { get; set; }

        [Display(Name = "Fecha de cierre"), DisplayFormat(DataFormatString = "{0:dd/MM/yyyy HH:mm}", ApplyFormatInEditMode = true)]
        ...
        public int PrioridadDeSoporteId { get; set; } = 1;
        ...
        [Display(Name = "Fecha de creación"), DisplayFormat(DataFormatString = "{0:dd/MM/yyyy HH:mm}", ApplyFormatInEditMode = true)]
        [DataType(DataType.Text)]
