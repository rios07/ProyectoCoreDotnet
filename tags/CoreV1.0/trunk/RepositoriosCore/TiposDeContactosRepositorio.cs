...
namespace RepositoriosCore
{
    ...
    public class TiposDeContactosRepositorio : BaseRepositorios<TiposDeContactos, TiposDeContactosExt>, ITiposDeContactosRepositorio
    {
        ...
        {
            return (List<TiposDeContactosExt>)CustomMultipleQuery<object,TiposDeContactosExt>(new {Seccion = pControllerBag.Seccion },"usp_TiposDeContactos__ListadoDDLoCBXL_FiltrandoContexto",ref pControllerBag);
        }
    }
}