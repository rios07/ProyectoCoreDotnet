...
{
    public interface IRelAsig_Usuarios_A_RecursosServicio : IBaseServicios<RelAsig_Usuarios_A_Recursos, RelAsig_Usuarios_A_RecursosExt>
    {
    ...
    public class RelAsig_Usuarios_A_RecursosServicio : BaseServicios<RelAsig_Usuarios_A_Recursos, RelAsig_Usuarios_A_RecursosExt>, IRelAsig_Usuarios_A_RecursosServicio
    {
        private IRelAsig_Usuarios_A_RecursosRepositorio _RelAsig_Usuarios_A_RecursosRepositorio;

        public RelAsig_Usuarios_A_RecursosServicio(IRelAsig_Usuarios_A_RecursosRepositorio pRelAsig_Usuarios_A_RecursosRepositorio)
        {
        ...
        {
            return _RelAsig_Usuarios_A_RecursosRepositorio.InsertByUsuarioIdsString(pRecursoId,pUsuarioIdsString,ref pControllerBag);
        }
        public int UpdateByUsuarioIdsString(int pRecursoId, string pUsuarioIdsString, ref ControllerBag pControllerBag)
        {
            return _RelAsig_Usuarios_A_RecursosRepositorio.UpdateByUsuarioIdsString(pRecursoId,pUsuarioIdsString,ref pControllerBag);
        }

        public List<RelAsig_Usuarios_A_RecursosExt> ResponsablesDeRecurso(int pRecursoId,ref ControllerBag pControllerBag)
        {
