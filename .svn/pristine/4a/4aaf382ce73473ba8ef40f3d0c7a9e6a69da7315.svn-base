...
{
    public class
        TiposDeContactosController : BaseControladores<TiposDeContactos, TiposDeContactosExt, TiposDeContactosVM>
    {
        private readonly ITiposDeContactosServicio _TiposDeContactosServicio;

        public TiposDeContactosController(ITiposDeContactosServicio pTiposDeContactosServicio,
