namespace FuncionesCore
{
    public class FPaginasGeneral
    {
        ...
        {
            var link = " - <a href=\"" + pUrlListado + "\">abrir el listado</a>";
            if (pUrlListadoAvanzado == "")
                return link;
            return link + " - <a href=\"" + pUrlListadoAvanzado + "\">abrir el listado avanzado</a> ";
        }

        public static string LinksConcatenadosTodos(string pUrlSelected_Id, string pUrlListado, string pUrlAdd = "",
            string pUrlListadoAvanzado = "")
        {
            var link = " - <a href=\"" + pUrlSelected_Id + "\">abrir el registro cargado/actualizado</a>" +
                       " - <a href=\"" + pUrlListado + "\">abrir el listado</a> ";

            if (pUrlAdd != "") link = link + " - <a href=\"" + pUrlAdd + "\">agregarotroregistro</a>";
            if (pUrlListadoAvanzado != "")
        ...
        public class Notas
        {
            public static string Add(string pTexto)
            {
                ...
                return
                    "<br><br>(*): Campos Obligatorios // [#]: Máxima cantidad de caracteres permitidos. <br><br><b>Notas: </b><br>" +
                    pTexto;
            }
        ...
        public static string NoHayRegistrosParaListar_EnElPeriodoSeleccionado =
            "No Hay datos para mostrar en el período seleccionado.";

        public static string NoHayRegistrosSeleccionadosParaExportar =
            "Por favor, seleccione al menos 1 registro para poder continuar con el proceso de exportación.";

        public static string ExportadoConExito = "Los registros seleccionados fueron exportados con éxito.";

        public static string NoHayRegistrosParaGMAP =
            "Por favor, seleccione al menos 1 registro para poder mostrar el mapa.";
        ...
        public static string NoSePudoModificarYaExisteUnoConEsosDatos =
            "El registro no se pudo actualizar, ya existe otro con esos mismos datos.";

        public static string TieneEnlazadoUnRegistro =
            "No se puede operar en este registro, existe un error de elazado.";

        public static string NoTieneAutorizacionParaVerEstaPagina =
            "No tiene Autorización para ver esta página, disculpe las molestias.";

        public static string NoTieneAutorizacionParaVerEsteRegistro =
            "No tiene Autorización para ver este registro, disculpe las molestias.";

        public static string NoTieneAutorizacionParaModificarEsteRegistro =
            "No tiene Autorización para modificar este registro, disculpe las molestias.";

        public static string NoTieneAutorizacionParaModificarEsteRegistro_Base =
            "No se puede modificar este registro, por que es un registro \"Base\" del sistema.";

        public static string NoTieneAutorizacionParaModificarRegistros =
            "No tiene Autorización para modificar registros de éste módulo, disculpe las molestias.";
        ...
        public static string NoSePuedeEliminarTieneEnlazadoUnRegistro =
            "Este registro no puede ser eliminado por que está siendo utilizado en el sistema";

        public static string ErrorActualizandoElRegistro = "Se produjo un error al actualizar los datos del registro. ";

        public static string ErrorAlCargarElRegistro =
            "Se produjo un error al cargar el registro. La página no puede ser mostrada. ";
        ...
        public static string ElRegistroSeEncuentraActivo =
            "<p class=\"p-Activo\">El Registro se encuentra Activo. </p>";

        public static string ElRegistroSeEncuentraAnulado =
            "<p class=\"p-Anulado\"> El Registro se encuentra Anulado. </p>";

        public static string ElRegistroSeEncuentraDesactivado =
            "<p class=\"p-Anulado\"> El Registro está Desactivado. </p>";
        ...
        public static string RegeolozalizarDirecciones =
            "Se regeolocalizarán todas las direcciones pertenecientes a la calle seleccionada. Esta operación puede demorar unos instantes. ¿Desea continuar?";
        ...
        public static string CantidadRegistrosListados(string pNumero, string pBuscar = "",
            string pDeTotalDeRegistros = "0")
        {
            var textoTotalDeRegistros = "";
            if (!(pDeTotalDeRegistros == "0")) textoTotalDeRegistros = "(De un total de " + pDeTotalDeRegistros + ")";
            string respuesta;
            switch (pNumero)
            {
                case "0":
            ...
            if (string.IsNullOrEmpty(pBuscar))
                return respuesta;
            return respuesta +
                   "<font color=\"black\">   ---  Resultado filtrado con el parámetro: </font><font color=\"red\">\"" +
                   pBuscar + "\"</font><font color=\"black\">   ---  </font>";
        }
