...
namespace ControladoresCore.ViewModels
{
    public class NotasVM : BaseVM
    {
        ...
        [Display(Name = "Creada"), DisplayFormat(DataFormatString = "{0:dd/MM/yyyy HH:mm}")]
        public DateTime Fecha { get; set; } = FuncionesCore.FFechas.FechaAhora();
        public string FechaParaListado { get; set; }

        [Display(Name = " ")]
        public string IconoCSS { get; set; }
        [Display(Name = "Vencimiento"), DisplayFormat(DataFormatString = "{0:dd/MM/yyyy}", ApplyFormatInEditMode = true), Required]
