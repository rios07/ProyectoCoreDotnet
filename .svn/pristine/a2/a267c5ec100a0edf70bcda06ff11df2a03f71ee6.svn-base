...
namespace ModelosCore
{
    ...
    public class Cualquiera
    {
        [
            ...
            // Required,  lo comento por q ya está el con mensaje, pero puede ir sin.
            StringLength(150),
            // Ver que el siguiente se puede extender a muchas otros DataType.
            DataType(DataType.Currency, ErrorMessage = "Introduzca un número"),
            Compare("Pass", ErrorMessage = "El dato no coincide con el password") // Compara a Pass2 con Pass
            ]
        ...
        [DataType(DataType.Date)]
        [Display(Name = "Precio(*)"), DisplayFormat(DataFormatString = "{0:C}", ApplyFormatInEditMode = false), Required]
        ...
        [StringLength(20, MinimumLength = 4, ErrorMessage = "El nombre de Ciudad debe tener una longitud entre {1} y {2} caracteres")]
