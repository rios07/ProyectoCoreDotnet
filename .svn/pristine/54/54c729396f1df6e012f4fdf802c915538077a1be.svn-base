...
namespace ControladoresCore.ViewModels
{
    ...
    public class InformesVM : BaseVM //, IValidatableObject
    {
        ...
        [AllowHtml]
        [Display(Name = "Contenido"), Required(ErrorMessage = "El contenido es requerido")]
        ...
        [Display(Name = "Categoría"), Key, Range(0, 9999), Required(ErrorMessage = "La categoría es requerida")]
