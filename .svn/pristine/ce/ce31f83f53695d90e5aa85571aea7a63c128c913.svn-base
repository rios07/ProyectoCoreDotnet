namespace FuncionesCore
{
    ...
    {
        //public string SeAgregoConExitoElRegistro(id As String)
        //{ 
        //    Return Paginas.p_General.Mensajes.EjecucionEnBD.SeAgregoConExitoElRegistro(Urls.Selected_Id(id), Urls.Listado, Urls.Add)
        //}
