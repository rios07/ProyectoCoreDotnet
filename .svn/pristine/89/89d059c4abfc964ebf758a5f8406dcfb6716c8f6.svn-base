...
namespace _DatosDelSistema
{
    public class FechasYHoras
    {
        ...
        {
            string anio = Convert.ToString(FechaYTiempoAhora());
            string mes = Convert.ToString(FechaYTiempoAhora());
            string dia = Convert.ToString(FechaYTiempoAhora());

            return anio + "-" + mes + "-" + dia + "_" + FechaYTiempoAhora().ToShortTimeString().Replace(":", "-") + "hs";
        }
