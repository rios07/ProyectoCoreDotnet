...
namespace RepositoriosCore
{
    public interface IUsuariosRepositorio : IRepositorio<Usuarios, UsuariosExt>
    {
        ...
        IEnumerable<RetornoLogin> LoginAD(string pUserName, ref ControllerBag pControllerBag);
    ...
    public class UsuariosRepositorio : BaseRepositorios<Usuarios, UsuariosExt>, IUsuariosRepositorio
    {
        ...
        public IEnumerable<RetornoLogin> LoginAD(string pUserName, ref ControllerBag pControllerBag)
        {
            object obj = new {UserName = pUserName};
            return CustomMultipleQuery<object, RetornoLogin>(obj, "usp_Usuarios__login_DeComprobacionAD", ref pControllerBag);
        }
        ...
        public void ResetPass(string pPass, int pUsuarioId, ref ControllerBag pControllerBag)
        {
            ...
            CustomExecute(pass, "usp_Usuarios__Update_Campos_Reset_Pass", ref pControllerBag);
        }
    }
    ...
    public class RetornoLogin
    {
        ...
        public string Contexto_Codigo { get; set; }
