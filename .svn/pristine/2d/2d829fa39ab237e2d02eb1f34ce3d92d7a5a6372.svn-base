...
namespace PruebasCore.Funciones
{
    ...
    public class FContraseniasPruebas
    {
        ...
        public void TestCumpleMinimosRequerimientos()
        {
            ...
            Assert.AreEqual("La contraseña no cumple los requisitos minimos de seguridad", FContrasenias.CumpleMinimosRequerimientos("renegados"));
            //No, por largo.
            Assert.AreEqual("La contraseña no contiene el minimo numero de caracteres", FContrasenias.CumpleMinimosRequerimientos("asd"));
        }
