...
namespace ControladoresCore.Base
{
    public class BaseGlobal
    {
        ...
        {
            return Mapper.Configuration.GetAllTypeMaps().Where(m => m.SourceType == source && m.DestinationType == dest)
                .Count() > 0;
        }
        ...
        public class CoreMappings : Profile
        {
            public CoreMappings()
            {
               ...
               // CreateMap<Tareas, TareasVM>();
                ...
                CreateMap<LogLoginsDeDispositivos, LogLoginsDeDispositivosVM>();
                CreateMap<LogLoginsDeDispositivosExt, LogLoginsDeDispositivosVM>();
