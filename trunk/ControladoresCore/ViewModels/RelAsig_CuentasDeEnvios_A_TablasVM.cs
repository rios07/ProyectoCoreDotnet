...
namespace ControladoresCore.ViewModels
{
    public class RelAsig_CuentasDeEnvios_A_TablasVM : BaseVM
    {
        ...
        [Campo("CuentaDeEnvioId")] public List<CuentasDeEnviosVM> Cuentas { get; set; }

        public string Tabla { get; set; }

        [Display(Name = "Nombre de cuenta")] public string CuentaDeEnvio { get; set; }

        [Display(Name = "Cuenta de email")] public string CuentaDeEmail { get; set; }
