...
{
    /// <summary>
    ///     ''' Clase utilizada para manipular imágenes. Utilizar ResizeImageSTD/MakeThumbnail + SaveJPGWithCompressionSetting
    ///     para redimensionar y guardar imágenes o sus thumbnails
    ///     '''
    /// </summary>
    /// '''
    /// <remarks></remarks>
    public class FImagenes
    {
        ...
        /// '''
        /// <remarks></remarks>
        private static readonly double[] StandardRelations = {4 / (double) 3, 16 / (double) 9};


        private static void GetDimensionsForAspectRatio(ref int w2, ref int h2, Image imgPhoto,
            eFormatoDimensionimagen enuFormatoDimensionimagen)
        {
            var dRelacionDeSalida =
                ValorDecimalFormatoDimensionimagen(enuFormatoDimensionimagen); // Por ejemplo = 4/3= 1,33333...
        ...
        {
            var nPercent = Convert.ToSingle(Percent) / (double) 100;
        ...
        {
            var Err = 0.1; // Ajustar según corresponda
        ...
        /// <summary>
        ///     ''' Función para obtener una miniatura de la imagen original, la miniatura tiene relación 4:3, independientemente
        ///     de la original, utiliza CROP
        ///     '''
        /// </summary>
        /// '''
        /// <param name="img"></param>
        ...
        public static Image MakeThumbnail(Image img, int w2)
        {
            ...
            var img_crop = Crop(img, w_crop, h_crop, AnchorPosition.Center);
        ...
        {
            var Extenciones = new List<string>();
            Extenciones.Add("png");
            Extenciones.Add("gif");
            Extenciones.Add("bmp");
            ...
            foreach (var extencion in Extenciones)
        ...
        private enum eFormatoDimensionimagen
        {
            wxh_NoStd = 0,
            wxh_4x3 = 1,
            wxh_16x9 = 2
