namespace FuncionesCore
{
    public class FUbicaciones
    {
        ...
        {
            var ruta = "E:\\InetPub\\WebIntraIatasa_Downloads\\" + pDir.Replace("/", "\\") + "\\";
            return ruta.Replace("//", "/");
        }

        public static string Previews(string pDir)
        {
            var ruta = "~/___Previews/" + pDir.Replace("/", "\\") + "\\";
            return ruta.Replace("//", "/");
        }
        ...
        public static string DeAdjuntosDeComunicaciones(string pNombreCarpetaContrato,
            string pNombreCarpetaComunicacion)
        {
