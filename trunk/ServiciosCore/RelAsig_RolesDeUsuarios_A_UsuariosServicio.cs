...
{
    public interface IRelAsig_RolesDeUsuarios_A_UsuariosServicio : IBaseServicios<RelAsig_RolesDeUsuarios_A_Usuarios,
    ...
    public class RelAsig_RolesDeUsuarios_A_UsuariosServicio :
        BaseServicios<RelAsig_RolesDeUsuarios_A_Usuarios, RelAsig_RolesDeUsuarios_A_UsuariosExt>,
        IRelAsig_RolesDeUsuarios_A_UsuariosServicio
    {
        private readonly IRelAsig_RolesDeUsuarios_A_UsuariosRepositorio _rolUsuarioRepositorio;
        private readonly IUsuariosRepositorio _usuariosRepositorio;

        public RelAsig_RolesDeUsuarios_A_UsuariosServicio(
            IRelAsig_RolesDeUsuarios_A_UsuariosRepositorio pRolUsuarioRepositorio,
        ...
        public override IRepositorio<RelAsig_RolesDeUsuarios_A_Usuarios, RelAsig_RolesDeUsuarios_A_UsuariosExt>
            GetRepositorio()
        {
