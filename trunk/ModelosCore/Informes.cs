...
namespace ModelosCore
{
    ...
    public class Informes : BaseModelo
    {
        ...
        [Ignorar(Operacion.update)] public int? UsuarioId { get; set; } = -2;

        public string Titulo { get; set; }
        public string Texto { get; set; }
        public string Observaciones { get; set; }

        [Ignorar(Operacion.update)] public DateTime FechaDeInforme { get; set; }
    ...
    public class InformesExt : Informes
    {
        ...
        public string FechaDeInformeFormateado { get; set; }
